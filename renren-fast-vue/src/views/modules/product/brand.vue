  ...
  <div class="mod-config">
      ...
      <el-aside style="width: 100%;">
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
          ...
          <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="updateCatelogHandle(scope)">关联</el-button>
    ...
    <el-dialog title="关联分类" :visible.sync="cateRelationDialogVisible" width="30%">
      <el-popover placement="right-end" v-model="popCatelogSelectVisible">
        <category-cascader @getcascader="getcascader"></category-cascader>
  ...
  methods: {
    ...
    addCatelogSelect() {
      ...
      this.$http({
        ...
        method: "post",
        data: this.$http.adornData({ brandId: this.brandId, catelogId: this.catelogPath }, false)
      }).then(({ data }) => {
    ...
    updateCatelogHandle(scope) {
      this.cateRelationDialogVisible = true;
      this.brandId = scope.row.brandId;
      this.brandName = scope.row.descript;
      this.getCateRelation();
    },
    getCateRelation() {
      this.$http({
