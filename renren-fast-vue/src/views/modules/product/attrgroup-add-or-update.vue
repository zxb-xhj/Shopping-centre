<template>
  <el-dialog :title="!dataForm.attrGroupId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" @closed="dialogclosed()">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      ...
      <el-form-item label="所属分类id" prop="catelogId">
        ...
        <el-cascader v-model="dataForm.catelogIds" :options="categors" :props="props"></el-cascader>
      </el-form-item>
    </el-form>
