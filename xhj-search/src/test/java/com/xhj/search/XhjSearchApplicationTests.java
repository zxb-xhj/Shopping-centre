...
class XhjSearchApplicationTests {
    ...
    public void searchData() throws IOException {
        ...
        //2. 执行检索
        SearchResponse searchResponse = restHighLevelClient.search(searchRequest, XhjElasticSearchConfig.COMMON_OPTIONS);
    ...
    void index() throws IOException {
        ...
        //执行操作
        IndexResponse indexResponse = restHighLevelClient.index(indexRequest, XhjElasticSearchConfig.COMMON_OPTIONS);
